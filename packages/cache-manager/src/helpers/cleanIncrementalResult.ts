...
const convertNullArrayEntriesToUndefined = (data: PlainObjectMap | any[]) => {
...
export default (data: PlainObjectMap | any[]) =>
  [convertNullArrayEntriesToUndefined].reduce((acc, func) => func(acc), data);
