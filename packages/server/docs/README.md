...
*Defined in [defs/index.ts:26](https://github.com/badbatch/graphql-box/blob/3fa1e6d/packages/server/src/defs/index.ts#L26)*
...
*Defined in [defs/index.ts:24](https://github.com/badbatch/graphql-box/blob/3fa1e6d/packages/server/src/defs/index.ts#L24)*
