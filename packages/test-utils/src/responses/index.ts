...
export const singleTypeQuery: ResponseData = {
  data: {
    organization: {
      description:
...
export const singleTypeQuerySmallA: ResponseData = {
  data: {
    organization: {
      description:
        'We are working to build community through open source technology. NB: members must have two-factor auth.',
...
export const nestedTypeQuery: ResponseData = {
  data: {
    organization: {
      description:
        'We are working to build community through open source technology. NB: members must have two-factor auth.',
...
export const nestedUnionQuery: ResponseData = {
  data: {
    search: {
      edges: [
        {
...
export const deferQuery: ResponseData = {
  data: {
    organization: {
      description:
        'We are working to build community through open source technology. NB: members must have two-factor auth.',
...
export const getSearchResultsQuery: ResponseData = {
  data: searchResultsQuery,
};

export const nestedInterfaceMutation: ResponseData = {
  data: {
    addStar: {
      clientMutationId: '1',
      starrable: {
...
export const nestedInterfaceSubscription: ResponseData = {
  data: {
    __typename: 'Repository',
    id: 'MDEwOlJlcG9zaXRvcnkxMDA0NTUxNDg=',
    name: 'graphql-box',
...
export const nestedTypeSubscription: ResponseData = {
  data: {
    emailAdded: {
      emails: [
        {
