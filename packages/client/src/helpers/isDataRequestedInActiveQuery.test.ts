...
import isDataRequestedInActiveQuery from "./isDataRequestedInActiveQuery";
...
describe("isDataRequestedInActiveQuery", () => {
  describe("when data requested is not in active query", () => {
    it("should return undefined", () => {
      ...
      expect(isDataRequestedInActiveQuery([aciveQueryData], newRequestData, newRequestContext)).toBe(undefined);
    });
  });
