...
* **cache-manager:**  handle root node with args that is list of entities (b62fadf7)
...
* **cache-manager:**  more changes to data/cache metadata retrieval (7ce13d85)
...
* **cache-manager:**  if no field metadata exists cache pass (572d164a)
...
* **operation-parser:**  unwrap non null in list check (56a569db)
...
* **cache-manager:**  stop rejecting paths when within union (016ed3da)
...
* **cache-manager:**  update snapshot to remove class reference (1d4c0c28)
